...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list CONFIG.PCW_USE_M_AXI_GP1 {1} CONFIG.preset {ZC702}  ] $processing_system7_0
  ...
  create_bd_addr_seg -range 0x10000 -offset 0x80000000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axi_bram_ctrl_1/S_AXI/Mem0] SEG_axi_bram_ctrl_1_Mem0
