...
HD_PWD=/home/iq/Documents/marketinternational_filter/Example_reference/Zynq7000AP_SoC_Ethernet_Packet_Redirection_Design/HW/project/project.runs/synth_2
cd "$HD_PWD"
